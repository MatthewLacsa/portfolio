    ...
    return (
        <div className="relative h-screen w-screen flex justify-center gap-4">
                <motion.div
                    ...
                    <p className="text-3xl font-bold">Hey, My name is Matthew Lacsa! <Image src="/me.jpeg" alt="Profile" width="120" height="120" 
                ...
                >
                    <div className={`transition-all duration-500 ${expandedStack === 0 ? 'relative space-y-2 size-50' : 'stack size-50'} hover:scale-110`}>
                ...
                >
                    <div className={`transition-all duration-500 ${expandedStack === 1 ? 'relative space-y-2 size-50' : 'stack size-50'} hover:scale-110`}>
                        <div className="border-base-content card bg-base-100 border text-center h-50">
                            <div className="card-body">A</div>
                        </div>
                        <div className="border-base-content card bg-base-100 border text-center h-50">
                ...
                <motion.div
                    ...
                    className={`relative h-28 mt-10 z-5`}
                    onClick={() => setExpandedStack(expandedStack === 2 ? null : 2)}
                >
                    <div className={`transition-all duration-500 ${expandedStack === 2 ? 'relative space-y-2 size-50' : 'stack size-50'} hover:scale-110`}>
                        <div className="border-base-content card bg-base-100 border text-center h-50">
                            <div className="card-body">A</div>
                        </div>
                        <div className="border-base-content card bg-base-100 border text-center h-50">
